#ifndef SIMPLE_UTEST_H
#define SIMPLE_UTEST_H
...
#define simple_assert_nonnull(actual) _simple_assert_nonnull(actual, __LINE__)

#define simple_assert_true(actual) _simple_assert_true(actual, __LINE__)
